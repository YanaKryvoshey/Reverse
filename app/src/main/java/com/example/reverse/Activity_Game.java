...
public class Activity_Game extends AppCompatActivity {
    ...
    private void arrowClicked(int direction) {
        Log.d("pttt", "this.goodToGo:"+ this.goodToGo);
        Log.d("pttt", "direction:"+ ""+ direction);
        Log.d("pttt", "this.steps[this.currentLevel]:"+ ""+ this.steps[this.currentLevel]);
        Log.d("pttt", "this.steps:"+ ""+ this.steps);
